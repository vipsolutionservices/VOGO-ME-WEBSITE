...
<main>
    ...
    <section class="hero section">
      <div class="container hero-grid">
        <div class="hero-content">
          <p class="eyebrow">VOGO TECHNOLOGY • Mobile Applications • AI Plugin • crafted in Europe</p>
          <h1>Încredere și inovație, construite pentru scalare</h1>
          <p class="lead">
            Aplicații mobile reale, nu ambalaje. VOGO livrează aplicații native iOS și Android - publicate in Google Play si Apple store. Dezvoltate în Flutter, fără WebView, fără compromisuri de UX sau performanță. Wordpress/WooCommerce backend plugins.
          </p>
          <div class="hero-actions" aria-label="Acțiuni principale">
            <a class="btn btn-primary" href="#contact">Solicită demo</a>
            <a class="btn btn-outline" href="#services">Descoperă serviciile</a>
          </div>
        </div>
      </div>
    </section>

    <!-- Sub-hero carousel: three requested product visuals, auto-cycling and keyboard-friendly. -->
    <section class="section hero-carousel-section" aria-label="Carousel imagini VOGO WordPress">
      <div class="container">
        <div class="hero-carousel" role="region" aria-roledescription="carousel" aria-label="VOGO WordPress control center preview">
          <div class="hero-carousel-track">
            <figure class="hero-slide">
              <img src="img/vogo_wordpress_branc_control+center_1.png" alt="VOGO WordPress branch control center - ecran 1" loading="eager" decoding="async" />
            </figure>
            <figure class="hero-slide">
              <img src="img/vogo_wordpress_branc_control+center_2.png" alt="VOGO WordPress branch control center - ecran 2" loading="lazy" decoding="async" />
            </figure>
            <figure class="hero-slide">
              <!-- Uses the real filename from /img so the third carousel image is always visible. -->
              <img src="img/vogo_wordpress_branc_control+center_ai_asistance.png" alt="VOGO WordPress branch control center - ecran 3" loading="lazy" decoding="async" />
            </figure>
          </div>
        </div>
      </div>
    ...
    <!-- Portfolio overview section: listing VOGO offers with card-first navigation. -->
    <section id="overview" class="section">
      <div class="container">
        <h2>Products and Services by VOGO</h2>
